                ...
                match call.data:
                    ...
                    case "Команды_Модераторские":
                        if call.from_user.id==message.from_user.id:
                            ...
                            mod4="Задать правила <u>каждая строка и пункт правила писать на следующей строке</u>(Settings Rules <u>каждую строку и пункт правила писать на следующей строке</u>) - задаёт правила для чата\n"
